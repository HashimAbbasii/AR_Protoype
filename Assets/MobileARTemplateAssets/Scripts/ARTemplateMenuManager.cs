...
public class ARTemplateMenuManager : MonoBehaviour
{
    ...
    public void SetObjectToSpawn(int objectIndex)
    {
        ...
        {
            m_ObjectSpawner.spawnOptionIndex = objectIndex; // Set the selected object index
            m_ObjectSpawner.EnableSpawning(); // Enable spawning after setting the index
            Debug.Log("Object selection updated. Tap to spawn the object.");
        }
        else
        {
        ...
        HideMenu(); // Close the menu after selection
    }
